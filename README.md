...
В данном задании вам необходимо написать пробер и на основании метрик этого пробера подсчитывать SLA, а также отработать сценарии нарушения SLA.

Написать пробер, добавить его метрики в прометеус
Написать приложение по подсчету SLA, создать соглашение(состоящее из нескольких соглашений), добавить значения в виде графиков в графану(плохие минуты по индикаторам, и процент доступности)
Протестировать нарушение SLA, создать несколько аварийных ситуаций

---

**[Скринкаст](https://youtu.be/EsmmE3D1t7g)**
...
Добавить несколько простых алертов на основе метрик с экспортеров, с которыми мы работали ранее (Node Exporter, Blackbox Exporter, OnCall)
...
В предыдущих семинарах мы выстраивали полноценное observability приложения OnCall на основе метрик. Выделяли целевые показатели доступности сервиса SLO. Теперь нам выделили команду, которая может реагировать на инциденты 24х7. 

Вам необходимо:

Выделить и написать динамические правила алертирования в Prometheus для:
Критичных нарушений (Severity: Critical)
Некритичных нарушений (Severity: Warning)
...
**[Скринкаст](https://youtu.be/3edqI2SrDlo)**
...
2.сделать несколько инстансов приложения Oncall

3.настроить балансировку на Oncall

---

**[Скринкаст](https://youtu.be/OFFPI2O0owM)**

---

## 10.2

Необходимо проверить повышение отказоустойчивости и настроить мониторинг NGINX

Для этого необходимо:

1.переключить пробер и провести испытания с отключение нод oncall

2.завести метрики nginx в prometheus. Завести для него доски

---

**[Скринкаст](https://youtu.be/O10ltqwVMsE)**
